...
<body>
	<footer>
		...
		<div class="box3">
			<div class="left_bar">
				<div>
					<a href="/shoekream/admin/notice/list" class="footer_a">고객지원</a>
				</div>
				<div>
					<a href="/shoekream/admin/notice/list" class="footer_a">공지사항</a>
				</div>
				<div>
					<a href="/shoekream/admin/qna/list" class="footer_a">1:1문의</a>
				</div>
				<div>
					<a href="/shoekream/admin/request/list" class="footer_a">상품 등록 문의</a>
				</div>
			</div>
			<div class="icons">
				<div>
			...
			<div class="faq">
				<button class="faq_button">
					<a href="/shoekream/admin/faq/list" class="footer_a" >자주 묻는 질문</a>
				</button>
			</div>
		</div>
		<div class="box4"></div>
