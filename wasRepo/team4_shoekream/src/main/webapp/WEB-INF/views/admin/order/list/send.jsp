    ...
    <%@page import="java.util.List" %>
        <%@page import="com.shoekream.page.vo.PageVo" %>
            <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                <% List<OrdersVo> OrderVoList = (List<OrdersVo>) request.getAttribute("OrderSendVoList");
                                                        ...
                                                        <tbody>
                                                            <tr class="order-item">
                                                                ...
                                                                <td class="status">
                                                                    ...
                                                                    <input type="radio" value="2" id="check" name="order_status" checked="checked">검수완료<br>
