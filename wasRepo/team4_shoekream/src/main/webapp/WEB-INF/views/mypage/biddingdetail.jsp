            ...
            <div class="buy_immediate">
                ...
                <div class="buy_product_area">
				     <div class="product_thumb">
				         <div class="porduct">
				             <img id="select_product" src=${ detailVo.productImg }>
				         </div>
				     </div>
				     <div class="product_detail">
				         <p class="code">${ detailVo.modelNumber }</p>
				         <p class="name">${ detailVo.productName }</p>
				         <p class="translated_name">${ detailVo.productNameKo }</p>
				         <div class="model_desc">
				             <p class="size_txt">${ detailVo.productSize }</p>
				         </div>
				     </div>
				</div>
                            ...
                            <div class="description_wrap">
                                <p class="line_description">
                                    <em class="title_txt" style="color:inherit;">
                                        ${ detailVo.finalPrice }원
                                    </em>
                                    <input class="totalAmount" type="hidden" name="totalAmount" value="${ detailVo.finalPrice }">
                                </p>
                            </div>
                        </div>
                                    ...
                                    <div class="address_info">
                                        <dl class="info_list">
                                            <div class="info_box">
                                                ...
                                                <dd class="desc">${detailVo.addressName}</dd>
                                            </div>
                                            <div class="info_box">
                                                <dt class="title">연락처</dt>
                                                <dd class="desc">${detailVo.phone}</dd>
                                            </div>
                                            <div class="info_box">
                                                <dt class="title">배송 주소</dt>
                                                <dd class="desc">${detailVo.address}</dd>
                                            </div>
                                        </dl>
                                    </div>
