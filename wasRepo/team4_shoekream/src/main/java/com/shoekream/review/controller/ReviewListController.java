...
public class ReviewListController extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      try {
    	  ...
    	  //data
    	  int listCount = rs.selectReviewCount();	//전체 게시글 갯수
         ...
         //service(layer 호출)
         List<ReviewVo> reviewVoList = rs.selectReviewList(pvo);
...
//         System.out.println("[ERROR-B001] 게시글 목록 조회 중 에러 발생...");
         ...
         req.getRequestDispatcher("/WEB-INF/views/review/mypage.jsp").forward(req, resp);
      }
   }
