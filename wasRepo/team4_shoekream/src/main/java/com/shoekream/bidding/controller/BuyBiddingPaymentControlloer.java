...
@WebServlet("/buy/biddingpayment")
public class BuyBiddingPaymentControlloer extends HttpServlet{
...
//				System.out.println("에러확인 cardInfo : " + cardInfo);
			...
			req.getRequestDispatcher("/WEB-INF/views/buy/biddingpayment.jsp").forward(req, resp);
		} catch (Exception e) {
			System.out.println("buyBiddingPayment 중 예외 발생");
			e.printStackTrace();
		}
	}
