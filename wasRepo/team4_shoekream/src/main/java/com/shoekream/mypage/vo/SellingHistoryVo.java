...
public class SellingHistoryVo {
	...
	public SellingHistoryVo(String memberNo, String biddingNo, String orderNo, String productNo, String productName,
	...
	public String toString() {
		return "SellingHistoryVo [memberNo=" + memberNo + ", biddingNo=" + biddingNo + ", orderNo=" + orderNo
