...
@WebServlet("/mypage/selling/bidList")

public class SellingBiddingController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			List<BiddingHistoryVo> bidList = service.viewSellingBiddingList(loginMember, map);
